//
//  SongDetailCommentDetailVC.swift
//  Muselink
//
...
class SongDetailCommentDetailVC: UIViewController {
...
extension SongDetailCommentDetailVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let imgURl = URL.init(string: chat.profileImage ?? "https://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2552&q=80") {
...
extension SongDetailCommentDetailVC: UIViewControllerTransitioningDelegate {
    public func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        PresentationController(presentedViewController: presented, presenting: presenting)
    }
}
extension SongDetailCommentDetailVC: UITextFieldDelegate ,GrowingTextViewDelegate {
