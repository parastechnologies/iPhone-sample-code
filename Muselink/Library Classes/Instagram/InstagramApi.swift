...
class InstagramApi {
    ...
    private let instagramAppID = "918408975582286"
    
    private let redirectURIURLEncoded = "https%3A%2F%2Fwww.muselink.app%2F"
    
    private let redirectURI = "https://www.muselink.app/"
    
    private let app_secret = "237a2e6eedc10a9837eeef8fdd9f972a"
    ...
    private func getTokenFromCallbackURL(request: URLRequest) -> String? {
        ...
        if requestURLString.starts(with: "https://www.muselink.app/?code=") {
            
            print("Response uri:",requestURLString)
            if let range = requestURLString.range(of: "https://www.muselink.app/?code=") {
