...
public struct YPColors {
    ...
    public var tintColor = UIColor.brightPurple
    ...
    public var photoVideoScreenBackgroundColor: UIColor = .darkBackGround

    /// The background color of the library and space between collection view cells.
    public var libraryScreenBackgroundColor: UIColor = .darkBackGround

    /// The background color of safe area. For example under the menu items.
    public var safeAreaBackgroundColor: UIColor = .darkBackGround

    /// A color for background of the asset container. You can see it when bouncing the image.
    public var assetViewBackgroundColor: UIColor = .darkBackGround
    
    /// A color for background in filters.
    public var filterBackgroundColor: UIColor = .darkBackGround

    /// A color for background in selections gallery. When multiple items selected.
    public var selectionsBackgroundColor: UIColor = .darkBackGround

    /// A color for bottom buttons (photo, video, all photos).
    public var bottomMenuItemBackgroundColor: UIColor = .darkBackGround
