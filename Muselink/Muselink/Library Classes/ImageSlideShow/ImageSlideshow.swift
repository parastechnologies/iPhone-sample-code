...
open class ImageSlideshow: UIView {
    ...
    func layoutScrollView() {
        ...
        scrollView.frame = CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height - 0)
        ...
        for view in slideshowItems.enumerated() {
            view.element.frame = CGRect(x: scrollView.frame.size.width * CGFloat(view.offset), y: 0, width: scrollView.frame.size.width, height: scrollView.frame.size.height)
        }
    ...
    func reloadScrollView() {
        ...
        for image in scrollViewImages {
            let item = ImageSlideshowItem(image: image, maximumScale: maximumScale)
