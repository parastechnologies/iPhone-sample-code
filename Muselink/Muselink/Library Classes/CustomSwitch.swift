...
public class CustomSwitch: UIControl {
    ...
    public var labelOff:UIImageView = UIImageView()
    public var labelOn:UIImageView = UIImageView()
...
extension CustomSwitch {
    ...
    fileprivate func setupLabels() {
        ...
        self.labelOff.image = #imageLiteral(resourceName: "Switch_close")
        self.labelOn.image  = #imageLiteral(resourceName: "Switch_tick")
