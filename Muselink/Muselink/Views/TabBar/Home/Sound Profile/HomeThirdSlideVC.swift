...
class HomeThirdSlideVC: UIViewController {
    ...
    @IBAction func action_ViewAll() {
        let newVC = self.storyboard?.instantiateViewController(withIdentifier: "SoundFileCommentVC") as! SoundFileCommentVC
        newVC.viewmodel = viewmodel
        parentVC?.tabBarController?.present(newVC, animated: true, completion: nil)
    }
...
extension HomeThirdSlideVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension HomeThirdSlideVC: UITextFieldDelegate ,GrowingTextViewDelegate {
    func textViewDidChangeHeight(_ textView: GrowingTextView, height: CGFloat) {
        inputViewContainerHeightConstraint.constant = height
    }
}
class Cell_Comment : UITableViewCell {
